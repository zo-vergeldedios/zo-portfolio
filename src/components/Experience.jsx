    ...
    <section id="experience" className="py-24">
      <div className="max-w-5xl mx-auto px-6">
        <div ref={ref} className="section-fade">
          <p className="font-mono text-orange-500 text-xs tracking-widest uppercase mb-3">// experience</p>
                  ...
                  <div className="bg-dark-700 border border-dark-500 rounded-md p-6 card-accent">
                    <div className="flex flex-wrap justify-between items-start gap-2 mb-3">
                      ...
                      <div className="text-right">
                        <p className="font-mono text-xs text-gray-500">{exp.period}</p>
          ...
          {/* Education */}
          <div className="mt-14">
            <p className="font-mono text-orange-500 text-xs tracking-widest uppercase mb-4">// education</p>
            <div className="bg-dark-700 border border-dark-500 rounded-md p-6 card-accent">
              <div className="flex flex-wrap justify-between items-start gap-2">
                <div>
                  <h3 className="font-display font-semibold text-white text-lg">{EDUCATION.degree}</h3>
                  <p className="text-orange-500 text-sm">{EDUCATION.school}</p>
                </div>
                <div className="text-right">
                  <p className="font-mono text-xs text-gray-500">{EDUCATION.period}</p>
                  <p className="font-mono text-xs text-gray-600">{EDUCATION.location}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Awards */}
          <div className="mt-14">
            <p className="font-mono text-orange-500 text-xs tracking-widest uppercase mb-4">// awards</p>
            <div className="grid md:grid-cols-2 gap-4">
              {AWARDS.map((a) => (
                <div key={a.title} className="bg-dark-700 border border-dark-500 rounded-md p-5 card-accent">
                  <h4 className="font-display font-semibold text-white mb-1">{a.title}</h4>
                  <p className="font-mono text-xs text-orange-500 mb-2">{a.org}</p>
